...
export type PickupDates = {
  ...
  pickup_time_sale_range: { end_time: string; start_time: string; id: number }[];
};
...
export type GroupOrderInfoProps = Partial<{
  ...
  /** 是否开团人  true/false */
  is_creator?: boolean;
  /** 拼单状态 A active , L lock , F finished , C cancelled */
  status?: string;
  key?: string;
  delivery_date?: string;
  /** 配送方式，配送：delivery，自提：pickup */
