...
const API_URL = "/ec/mkpl/restaurant/";
...
export const useGetVendorInfo = (
  ...
  return {
    Res: data,
    vendorInfoData: data?.object,
    vendorInfoError: error,
    vendorInfoIsValidating: isValidating,
    vendorInfoIsLoading: !error && !data,
    vendorInfoMutate: mutate,
  };
};
